package com.ps.formacion.shared.infrastructure.command;

import com.ps.formacion.shared.domain.bus.command.CommandHandler;
import com.ps.formacion.shared.domain.bus.command.CommandNotRegisteredError;
import org.reflections.Reflections;
import org.springframework.stereotype.Service;
import com.ps.formacion.shared.domain.bus.command.Command;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections                          reflections = new Reflections("com.ps");
