...
import com.ps.formacion.shared.domain.Service;
import com.ps.formacion.shared.domain.Utils;
import com.ps.formacion.shared.domain.bus.event.DomainEvent;
import com.ps.formacion.shared.infrastructure.event.DomainEventJsonDeserializer;
import com.ps.formacion.shared.infrastructure.event.DomainEventSubscribersInformation;
...
public final class RabbitMqDomainEventsConsumer {
    ...
    private void sendMessageTo(String exchange, Message message, String queue) throws AmqpException {
